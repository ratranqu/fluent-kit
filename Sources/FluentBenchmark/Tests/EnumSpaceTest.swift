...
extension FluentBenchmarker {
    public func testEnumSpace() throws {
        try self.testEnumSpace_basic()
        try self.testEnumSpace_addCases()
        try self.testEnumSpace_raw()
        try self.testEnumSpace_queryFound()
        try self.testEnumSpace_queryMissing()
        try self.testEnumSpace_decode()
    ...
    private func testEnumSpace_basic() throws {
    ...
    private func testEnumSpace_addCases() throws {
        try self.runTest(#function, [
            FooMigration(),
    ...
    public func testEnumSpace_raw() throws {
    ...
    public func testEnumSpace_queryFound() throws {
        // equal
        try self.runTest(#function, [
            FooMigration()
        ]) {
    ...
    public func testEnumSpace_queryMissing() throws {
        // equal
        try self.runTest(#function, [
            FooMigration()
        ]) {
    ...
    public func testEnumSpace_decode() throws {
        try runTest(#function, [
            FooMigration()
        ]) {
            let data = """
...
private struct FooMigration: Migration {
    ...
    func revert(on database: Database) -> EventLoopFuture<Void> {
        database.schema("foos", space: "b").delete().flatMap {
            database.enum("bar", space: "b").delete()
        }
    }
}
